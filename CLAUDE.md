...
- **Agent-Control-Plane Phase 5 SDK + Codegen**: IMPLEMENTED (`codegen/generate_wire_types.py`, TypeScript REST SDK, Python REST SDK package). Read-only Next.js dashboard and local Docker deploy remain future slices.
