...
- Dormant Adaptation Phase 4 (Dead Code Cleanup): Next — remove app_layer/, dispatch/manual/, harness/{sandbox,supervisor,batch_runner,sampling,model_eval}, storage/{durable_store,health_checker,storage_migrator}
- Dormant Adaptation Phase 4 (Dead Code Cleanup): Pending — delete app_layer/, dispatch/manual/, harness/{sandbox,supervisor,batch_runner,sampling,model_eval}, storage/{durable_store,health_checker,storage_migrator}
...
- **Current count**: 1318 Rust tests pass, 0 failures (as of 2026-06-06)
