...
- Dormant Adaptation Phase 1 (Interface Unification): Next — extract trait Evaluator, ModelProvider→Provider adapter, trait GraphOperations
- Dormant Adaptation Phase 2 (Zero-Conflict Activation): Pending — dag_manager, context_pack, work_queue, auto_policies, result_aggregator
