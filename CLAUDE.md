...
- Post-LGB Product Evolution — PE-1, PE-2, and PE-3 are acceptance-sealed; PE4-CONTRACT-REPAIR-1 is merged and PE4-OFFLINE-1 is the active packet; later PE-4 packets are packetized but not started; PE-5 and PE-6 remain unstarted; later stages are governed by `docs/NEXT_DECISION.md`
