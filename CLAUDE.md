...
- **Agent-Control-Plane Phase 6 Dashboard**: IMPLEMENTED (`dashboard/` Next.js App Router, read-only views, no executable controls). Local Docker deploy remains future slice.
