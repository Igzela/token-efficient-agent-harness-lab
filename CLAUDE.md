...
- Post-LGB Product Evolution — PE-1, PE-2, and PE-3 are acceptance-sealed; PE4-CONTRACT-REPAIR-1, PE4-OFFLINE-1, PE4-READ-1, and PE4-SHADOW-1 are merged; PE4-CANARY-1 is active, promotion is blocked on the canary merge, and PE4-CLOSE-1, PE-5, and PE-6 remain unstarted; later stages are governed by `docs/NEXT_DECISION.md`
