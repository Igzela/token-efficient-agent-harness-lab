...
ExecutorType = Literal["noop", "mock", "manual", "provider", "claude_code_cli", "codex_cli"]
ExecutionStatus = Literal["not_executed", "preview_generated", "mock_completed", "manual_pending", "manual_completed", "failed", "cli_completed", "provider_completed"]
