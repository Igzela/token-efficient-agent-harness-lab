...
- Macro-Orchestrator Direction: current product direction. Phase 1-5 repair batch COMPLETE. Self-Hosted GA Readiness SG-1 through SG-4 COMPLETE: real dynamic CLI pilot matrix, long-run soak/failure injection, mission-control dashboard visibility, and enriched policy decision signals are implemented. Next safe work is SG-5 GA runbook drills.
