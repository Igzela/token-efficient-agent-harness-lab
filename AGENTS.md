...
Batch 6 supervised-execution contracts and the Batch 7 implementation-plan artifact are planning artifacts only. Implementing sandbox/process/container/VM behavior, target workspace writes, approval broker wiring, rollback execution, artifact-capture runtime, or Batch 7 supervised execution still requires a separate explicit human-approved batch.
