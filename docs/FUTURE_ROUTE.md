...
The AC2 contract sketch was removed and the inventory manifest refreshed by accepted PR #468; the typed boundary-core sketch was promoted into `docs/NEXT_DECISION.md`, so the remaining first AC2 sketch below is caller migration.
