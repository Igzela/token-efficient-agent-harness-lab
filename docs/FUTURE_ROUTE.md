...
Deferred runtime-inventory and shared-process supervision hardening is not represented as executable successor packets; see the primary-route scope decision in `docs/CURRENT_STATUS.md`.
