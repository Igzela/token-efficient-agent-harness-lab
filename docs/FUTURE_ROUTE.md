...
- The explicit provider-free canary, single-writer cutover, guarded merge activation, and bounded effect envelopes are planned but not accepted capability.
