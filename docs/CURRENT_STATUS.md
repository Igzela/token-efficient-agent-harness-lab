...
8. Route bootstrap reconciliation and the first canonical provider-free soak have not run from the repaired accepted main. The terminated route10 material is retained only as non-resumable evidence from an obsolete main and cannot authorize or seed a continuation; resumption requires a fresh planning/bootstrap decision.
