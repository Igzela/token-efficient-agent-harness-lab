...
The core plan, V2 implementation, and Real Output Closeout are complete. The system includes prompt-to-CLI execution, bounded verification/repair evidence, optional real GitHub PR creation, a verified release contract, three real repository pilots, and a task-first dashboard. The Adaptive Fusion Routing track now includes AF-0 planning, AF-1 endpoint metadata, AF-2 offline evaluation, and AF-3 explicit bounded multi-provider execution.
...
- Branch: `codex/adaptive-fusion-af3`, stacked on `codex/adaptive-fusion-af2`.
- Tests: **1640 Rust tests pass**, 0 failures, recorded 2026-06-21 on `codex/adaptive-fusion-af3`.
...
| Adaptive Fusion Routing Track | AF-0 through AF-3 implemented; AF-4 contextual improvement and AF-5 operator UX pending |
...
- Automatic recommendation-to-live routing, contextual-bandit exploration, policy promotion/rollback, and adaptive operator UX remain unimplemented until AF-4 and AF-5.
