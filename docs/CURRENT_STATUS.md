...
| Measurement readiness | `BLOCKED_PREREQUISITE` | Estimands and finite corpus are accepted; operations/evidence is the current contract window and protocol-freeze remains routing-only |
