...
- CI: persisted trusted-local scheduler gate repair PR #116 run `28114258708` and post-merge main run `28114701272` were green across all seven jobs. The preceding persisted workflow gate main run `28011294700`, autonomy-policy main run `28010547977`, and persisted provider-config main run `27999545331` were also green.
