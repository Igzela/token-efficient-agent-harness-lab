...
- Branch: `main` at adaptive operator authority UI merge `89d542a`.
...
- CI: adaptive operator authority UI PR #102 run `27944383788` and post-merge main run `27944817747` were green across all seven jobs; completion-readiness PR #101 run `27941982296` and operator-validity PR #100 run `27940515194` were also green.
