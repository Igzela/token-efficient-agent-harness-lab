...
PRs #268–#280 are merged. Residual Seal 2 owns current Golden Path live acceptance (subscription Claude → approval → Draft PR); PR #225 remains an independent presentation-only lane. Do not activate Real Workload Evidence, Level-2, Meta Improver, Vader, or Issue #208 yet.
