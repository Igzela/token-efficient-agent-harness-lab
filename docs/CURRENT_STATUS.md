...
8. Route bootstrap reconciliation and the first canonical provider-free soak have not yet run from repaired accepted main `9cc118fa72d9d13a24cdf968cc5fc20dbe80b28f`. The fresh planning decision authorizes one new attempt; the terminated route10 material remains only non-resumable evidence from an obsolete main and cannot authorize or seed that attempt.
