...
| V2 four-cell run and closeout | `IN_PROGRESS` | Operator EFFECT `run-live-20260813-v2c` / `auth-live-v2-003` reached 4/4 `controlled_failure`; no seal; no target-default-branch write |
