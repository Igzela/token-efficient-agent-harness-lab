...
| `PE7-ROUTE-AUTOMATION-1` | `COMPLETE` | PR #390 exact head `24618e52c969adc93e7bc092c51dde6b2d0ffea9`; merge `5481053c736e7db8481cabd9316741f2a5cd6c7a`; exact-head `PASS`; canonical workflow `31467821768`; one accepted pre-ledger implementation is eligible only for route-run's merge-backed bootstrap reconciliation into the existing promotion owner |
