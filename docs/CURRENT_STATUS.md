...
- Latest accepted baseline: PR #628 exact head `07e9080f176c7176f6c55a7b966fac1ea4fa8c1b`, squash-merged as `1dda023ace9f2bef7ec54ac3fc316693a145dfa7`; it freezes the provider-free Mission/Stage/WorkCard contract, digest-bound owner approval, bounded grants and budgets, fail-closed stop taxonomy, and read-only compatibility boundary while retaining the legacy controller as the sole lifecycle writer. PR #626 remains the accepted baseline recovery merge `3f5a3c305d317e5fa160369ac3965adae4634721`; the preceding C1 implementation remains accepted through PR #621 merge `628577c5e8cb404c4dcc2e689925414bbfda70ab`, with the exact-head review-receipt gate hardened by PR #622 (merge `bd4d5d3279664906bfa6215f11f6a42b3a1654fc`). No Provider call, credential-value read, target write, authority consumption, enforcement escape, or live effect was authorized by these provider-free merges.
