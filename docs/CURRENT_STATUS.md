...
- Active runtime/code baseline: PR #370 merge `3b4afb3e5ab4254904aa5a63473ab6ae0eac1e82`; later PR #373 changed only canonical documentation and does not change that code identity. Always refresh remote `main` for the current canonical-document head.
