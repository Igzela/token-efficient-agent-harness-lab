...
| V2 four-cell run and closeout | `DECISION_REQUIRED` | EFFECT parked; needs a finite T3 GO and independent receipt; no Provider/four-cell execution authorized |
