...
- CI: persisted trusted-local workflow gate repair PR #115 run `28010891218` and post-merge main run `28011294700` were green across all seven jobs. The preceding autonomy-policy main run `28010547977` and persisted provider-config main run `27999545331` were also green.
