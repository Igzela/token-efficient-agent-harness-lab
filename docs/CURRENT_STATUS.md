...
- CI: persisted trusted-local provider config PR #111 run `27999251591` and post-merge main run `27999545331` were green across all seven jobs. Trusted-local execution gate PR #106 run `27966637107`, post-merge main run `27967126428`, status-refresh main run `27967612746`, and final head-bound wording main run `27968114851` were also green.
