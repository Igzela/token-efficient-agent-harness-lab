...
- Branch: `main` at completion-readiness hardening merge `11b21f3`.
...
- CI: completion-readiness hardening PR #101 workflow run `27941982296` and operator-validity hardening PR #100 workflow run `27940515194` were green across all seven jobs; they merged as `11b21f3` and `0926f4e`.
