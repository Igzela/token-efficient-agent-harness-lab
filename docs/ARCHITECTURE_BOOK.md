...
- Bounded supervised workers are merged in V2-4 and Mission Control product output UX is implemented in V2-5 PR #74, pending CI/merge; unattended autonomous-agent loops remain out of scope.
