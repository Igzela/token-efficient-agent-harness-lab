...
| Normal repository entry | `START_HERE.md`; optional projection in `scripts/session_context.py` | Ordinary inspect/edit/verify flow; no generated task card or lifecycle state | Product/runtime authority, provider effects, deployment, release, protected `main` mutation, review/CI bypass, or merge |
