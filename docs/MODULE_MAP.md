...
3. PE-1, PE-2, and PE-3 are acceptance-sealed; PE4-CONTRACT-REPAIR-1 and PE4-OFFLINE-1 are merged; PE4-READ-1 is in progress and shadow/canary/promotion branches are prepared but not merged. PE4-CLOSE-1 remains unstarted.
...
5. Complete PE4-READ-1 from the merged trace contract and offline replay owner; prepared shadow, canary, and promotion branches may be reviewed while CI is monitored but cannot merge before predecessor and post-merge main verification. Replay remains derived and non-mutating.
