...
| Candidate lineage/archive | `LocalProductStore`, migrations, integrity, backup/restore, audit | app-owned versioned evidence with exact parent/base/patch/evaluation identities; no second event store or vector service |
