...
| `engine/src/feedback/` | active policy evidence | Run traces, shadow routes, simulation/proposals, guarded adjustment snapshots, AF-0 portfolio planning, AF-1 endpoint registry | `cargo test -p engine --test test_adaptive_fusion --test test_model_endpoint_registry` |
