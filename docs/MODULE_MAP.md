...
| PE-3 operator decision contracts and deterministic resolution | `engine/src/operator_decision.rs`; future source adapters reuse existing approval/workflow/scheduler/budget/benchmark/policy/rollback/recovery readers |
