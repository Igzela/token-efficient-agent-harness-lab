...
- **Rust engine tests** (`cargo test -p engine`): 1157 parity/component/API test cases, including local small-team state/API coverage and provider audit/usage bridge coverage.
