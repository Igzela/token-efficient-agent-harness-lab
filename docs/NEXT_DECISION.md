...
`emergency_stop=true`, and old-writer status unverified until the preflight
active-run/claim readback completes. The capsule never claims that an
emergency stop alone terminated an already-running workflow.
