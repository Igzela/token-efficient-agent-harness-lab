...
2. **Frozen inputs.** Accepted current main is e34d1ae3c3ecf5e6c919c71a3d26d6690a66444. The RWE artifact freeze point is separately bound by `OPERATOR_ARTIFACTS_FROZEN_AT_MAIN_SHA` in `engine/src/rwe/operator_corpus.rs` to ee43eac853644266614da09de764a3bf19f2d281; these two identities must not be conflated. The source repository is https://github.com/Igzela/alters-lab at commit 6240768506320a324d68787b9eaa86971c8c930c, source tree 137e912f416a3a8d5be307e91bb2580154fc8fc34c6de52c2441ef3e3f93a064. The corpus, protocol, and schedule bindings are 044fcd7bf4c35c6a4798f60b5b87d79d8549b45351f4e350b397a63a0fe2ce20, bc68bfb320f891ee5490019385c17d71ee7bfc725bb43cd0c006d33c5d5d35db, and 6a729f1213384d2306091ce5f258c9ddd08fe569374167c04e7f10c930cb1b38. Task-definition hashes are fcd13b6f7a970c048fd09e1f723a315b8e03d221cad1555bf694ca95115438f8 and f49e374d8b818d9e2cf4566d6fb3323c472a3dd449ebc71413eab96891124e7d.
3. **Field owners and dispositions.**

| Required field(s) | Existing owner or frozen output | Missing or ambiguous rule |
|---|---|---|
| accepted current main, RWE artifact freeze point, source commit/tree, corpus/protocol/schedule, task definitions | accepted-main receipt; `engine/src/rwe/operator_corpus.rs::OPERATOR_ARTIFACTS_FROZEN_AT_MAIN_SHA`; `engine/src/rwe/corpus.rs`; `engine/src/rwe/economic_protocol.rs`; `engine/src/rwe/execution_schedule.rs`; versioned engine/rwe/corpora/ artifacts | current-main and artifact-freeze identities are distinct; mismatch with either bound value stops protocol validation and no replacement is allowed |
...
| reviewer policy and task acceptance rubrics | frozen v2 protocol object `reviewer_policy`; `tasks[0].acceptance_rubric` for `rwe-minimum-t1-fix_flow_linkage`; `tasks[1].acceptance_rubric` for `rwe-minimum-t2-draft_contract_tests`; operations-evidence manifest | policy and rubrics are frozen before outcomes; task/cell reviewer evidence remains unavailable until an existing receipt proves it |
...
**Canonical serialization and digest.** The manifest identity is the SHA-256 of the UTF-8 bytes of the compact JSON object below, with lexicographically sorted object keys, array order preserved, no trailing newline, and no Markdown formatting included. `manifest_sha256 = b5e37c7c2419a3acb42a8f21dbf2ba56aa8ddabb995b84b644f1b116a3321c12`.

```json
{"accepted_main_sha":"e34d1ae3c3ecf5e6c919c71a3d26d6690a66444","authorization_schema":"rwe_run_authorization.v2","confidence_level":0.95,"corpus_sha256":"044fcd7bf4c35c6a4798f60b5b87d79d8549b45351f4e350b397a63a0fe2ce20","external_effect_limit":0,"interval_method":"paired-bootstrap-95","margins":{"machine_verification":-0.1,"recovery_failure":0.05,"reviewer_acceptance":-0.1,"verified_delivery_points":-0.1},"protocol_sha256":"bc68bfb320f891ee5490019385c17d71ee7bfc725bb43cd0c006d33c5d5d35db","reconstructable_until":"snapshot_receipts","repetitions_per_task":2,"restricted_raw_state":"UNAVAILABLE_NOW","rwe_artifact_freeze_main_sha":"ee43eac853644266614da09de764a3bf19f2d281","schedule_sha256":"6a729f1213384d2306091ce5f258c9ddd08fe569374167c04e7f10c930cb1b38","schema_version":"rwe_decision_baseline_protocol.v1","seeds":[2026080601,2026080602],"source_commit":"6240768506320a324d68787b9eaa86971c8c930c","source_tree_sha256":"137e912f416a3a8d5be307e91bb2580154fc8fc34c6de52c2441ef3e3f93a064","task_count":2,"task_definition_sha256":["fcd13b6f7a970c048fd09e1f723a315b8e03d221cad1555bf694ca95115438f8","f49e374d8b818d9e2cf4566d6fb3323c472a3dd449ebc71413eab96891124e7d"]}
```
