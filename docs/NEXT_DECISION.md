...
3. **Owners and paths.** RWE freeze owners: engine/rwe/corpora/rwe-minimum-first-corpus/v2/snapshot/pre_ac_harness_snapshot.v2.json, engine/src/rwe/corpus.rs, engine/src/rwe/economic_protocol.rs, engine/src/rwe/execution_schedule.rs, engine/src/rwe/operator_corpus.rs; frozen binding path: engine/src/rwe/frozen_rwe_bindings.rs; caller: engine/tests/test_pg_integration.rs; tests: engine/src/rwe/operator_corpus.rs, tests/test_verify_rwe_snapshot.py.
