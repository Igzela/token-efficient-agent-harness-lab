...
9. **Current reconstruction result.** Manifest sha256 `b3ad16b6f0bf99920c5181719d57a975e227cc82cc45cbd2817318b467d61585`; accepted-main operator-corpus checks `11 passed`; exact frozen source-task verification `1933 passed, 47 failed, 25 skipped, 1 xfailed` because required active YAML artifacts are absent from the exact source commit; no checked-in Rust toolchain pin. The manifest is `UNAVAILABLE_NOW`, `reconstructable=false`, and preflight promotion remains blocked.
