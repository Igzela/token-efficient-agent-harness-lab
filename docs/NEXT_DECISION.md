...
**Prerequisite:** `PE7-CONTROL-BINDING-INTEGRITY-REPAIR-1` is COMPLETE, and the status owner proves the accepted merge-backed route receipt used only by the bootstrap bridge. The fresh human GO is bound to accepted decision baseline `72c196aa03a5632bfbd47ba5f19cbc51a154889c`; the controller must derive the post-merge accepted main live before dispatch. Repair evidence remains authority PRs #406/#407/#409, implementation PR #408 merge `57a86c78c3f9611ce48c5bce249721af23db5532`, canonical workflow `31593460813`, and #405 correction workflow `31594277043`. Route10 remains non-resumable evidence only.
...
2. **Prerequisites and evidence.** Begin from accepted decision baseline `72c196aa03a5632bfbd47ba5f19cbc51a154889c`, refresh the post-merge accepted main live, prove the accepted route and repair receipts above, read back the #405 correction, and retain route10 only as non-resumable evidence.
