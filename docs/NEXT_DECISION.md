...
**Allowed delta:** docs/ARCHITECTURE_BOOK.md, docs/CURRENT_STATUS.md, docs/FUTURE_ROUTE.md, docs/MODULE_MAP.md, docs/NEXT_DECISION.md. Do not modify executable source or test paths; they are read-only evidence bindings in the dispatch capsule.
...
7. **Ordered implementation slices.** docs/ARCHITECTURE_BOOK.md, docs/CURRENT_STATUS.md, docs/FUTURE_ROUTE.md, docs/MODULE_MAP.md, docs/NEXT_DECISION.md: Promote the accepted AC3 contract in canonical documents only.
8. **Failure, recovery, and stop taxonomy.** Cleanup: No cleanup or runtime mutation is authorized; retain all existing ProductTask, audit, recovery, and evidence paths. (proved by docs/NEXT_DECISION.md:AC2); retention: Retain the accepted AC2 caller-migration receipt, exact-head review, canonical CI, merge, and refreshed-main evidence in CURRENT_STATUS. (proved by docs/NEXT_DECISION.md:AC2); decisions: authority unchanged (docs/MODULE_MAP.md:authority); evaluator unchanged (docs/CURRENT_STATUS.md:evaluator); recovery unchanged (docs/ARCHITECTURE_BOOK.md:recovery); schema unchanged (docs/CURRENT_STATUS.md:schema).
...
10. **Compatibility, rollback, and retention.** Revert the documentation-only promotion and restore the prior AC2 current window if the refreshed contract cannot be proven from accepted main. (proved by docs/NEXT_DECISION.md:AC2)
11. **Exit artifact.** Evidence destinations: Canonical route evidence. (proved by docs/NEXT_DECISION.md:AC2)
