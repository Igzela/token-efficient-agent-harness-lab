...
The primary-route scope decision is owned by `docs/CURRENT_STATUS.md`. The minimal AC0 data/trace freeze is accepted; the active window is the provider-free AC2 typed-execution contract. Deferred runtime-inventory and shared-`ProcessSupervisor` hardening is not part of the active packet.
...
```text
[window: PE7-AC2-CONTRACT-1 — READY_FOR_EXECUTION, provider-free]
...
1. `PE7-AC2-CONTRACT-1` — `READY_FOR_EXECUTION`

## Packet PE7-AC2-CONTRACT-1

**State:** `READY_FOR_EXECUTION`

**Prerequisite:** PE7-AC0-TRACE-ORDER-FREEZE-1 — COMPLETE on accepted main `a4879fc60f1c080579df7ba942793a4c94367ff5` (PR #467 exact head `19cc238fec27236873262c12998eabe2eda26ac4`; merge `a4879fc60f1c080579df7ba942793a4c94367ff5`; exact-head `PASS`; canonical workflow `31869014363`).
...
2. **Prerequisites and evidence.** Accepted main `a4879fc60f1c080579df7ba942793a4c94367ff5`; checked route manifest SHA `fb92c84128b6a27cc51dd24608d5521483cc003f6de66a5ad687c6c3ae231fe1`; predecessor receipt PR #467 exact head `19cc238fec27236873262c12998eabe2eda26ac4`; merge `a4879fc60f1c080579df7ba942793a4c94367ff5`; exact-head `PASS`; canonical workflow `31869014363`; current-main evidence SHA `bb23eac8e3825a2309e8da8bfd8774cf4c30ac25c6dde66fa669ef0eb89e0e44`.
...
7. **Ordered implementation slices.** docs/CURRENT_STATUS.md: record the AC2 typed state/outcome/usage contract and existing owner boundaries; docs/NEXT_DECISION.md: promote the AC2 contract with its exact provider-free contract scope; docs/FUTURE_ROUTE.md: remove the promoted AC2 contract sketch and refresh the checked manifest
