...
**Allowed delta:** `docs/CURRENT_STATUS.md`, `docs/NEXT_DECISION.md`, `docs/FUTURE_ROUTE.md`, `engine/src/rwe/frozen_rwe_bindings.rs`, and `engine/src/rwe/live_baseline_coordinator.rs` only.
