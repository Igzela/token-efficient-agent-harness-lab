...
**Allowed delta:** `engine/src/product_golden_path.rs`, `tests/test_ask_sol.py`, `docs/CURRENT_STATUS.md`, `docs/NEXT_DECISION.md`, and `docs/FUTURE_ROUTE.md`; repository-control mutations are limited to the exact `main` ruleset and PR/Issues #574, #623, and #383 after recovery snapshots and readback.
