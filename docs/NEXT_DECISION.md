...
**Historical evidence:** PR #490 exact head `61d702dd166b430bdc64634e94d8157443f2ac25`; merge `40c648a6de7e2288485af936d6274068a3d1b394`; exact-head `PASS`; canonical workflow `31928462592`.
## Packet PE7-AC4-VIEWS-CORE-1

**State:** `READY_FOR_EXECUTION`

**Prerequisite:** PE7-AC4-CONTRACT-1 — COMPLETE on accepted main `40c648a6de7e2288485af936d6274068a3d1b394` (PR #490 exact head `61d702dd166b430bdc64634e94d8157443f2ac25`; merge `40c648a6de7e2288485af936d6274068a3d1b394`; exact-head `PASS`; canonical workflow `31928462592`).

**Class:** `IMPLEMENT`

**Outcome:** Implement the accepted borrowed transaction views for SQLite and PostgreSQL.

**Allowed delta:** docs/ARCHITECTURE_BOOK.md, docs/CURRENT_STATUS.md, docs/FUTURE_ROUTE.md, docs/MODULE_MAP.md, docs/NEXT_DECISION.md, engine/src/storage/local_product_store/product_tasks.rs, engine/tests/test_product_golden_path_g3.rs, tests/test_session_context.py.
...
2. **Prerequisites and evidence.** Accepted main `40c648a6de7e2288485af936d6274068a3d1b394`; checked route manifest SHA `854c09e9146c70bdf29775126db716f5c9449c4b828b5d209ef1906b686751e5`; predecessor receipt PR #490 exact head `61d702dd166b430bdc64634e94d8157443f2ac25`; merge `40c648a6de7e2288485af936d6274068a3d1b394`; exact-head `PASS`; canonical workflow `31928462592`; current-main evidence SHA `14d08c60b53be56ca4798f51d2098f51c2c9e5946defe1c02e7bf530c634b38a`.
...
7. **Ordered implementation slices.** docs/ARCHITECTURE_BOOK.md, docs/CURRENT_STATUS.md, docs/FUTURE_ROUTE.md, docs/MODULE_MAP.md, docs/NEXT_DECISION.md: Bind the accepted AC4 views core execution window.; engine/src/storage/local_product_store/product_tasks.rs, engine/tests/test_product_golden_path_g3.rs, tests/test_session_context.py: Implement borrowed transaction views for SQLite and PostgreSQL with atomicity tests.
8. **Failure, recovery, and stop taxonomy.** Cleanup: No runtime mutation or cleanup required for internal transaction views. (proved by docs/ARCHITECTURE_BOOK.md:recovery); retention: Retain the accepted AC4 contract receipt. (proved by docs/CURRENT_STATUS.md:receipt); decisions: authority unchanged (docs/MODULE_MAP.md:authority); evaluator unchanged (docs/CURRENT_STATUS.md:evaluator); recovery unchanged (docs/ARCHITECTURE_BOOK.md:recovery); schema unchanged (docs/CURRENT_STATUS.md:schema).
9. **Verification.** cargo test -p engine; uv run --no-project python scripts/check_agent_handoff.py; git diff --check
10. **Compatibility, rollback, and retention.** Revert the transaction view core implementation if backend parity diverges. (proved by docs/ARCHITECTURE_BOOK.md:recovery)
