...
**Prerequisite:** PE7-AC2-CALLER-MIGRATION-1 — COMPLETE on accepted main `8beeacfaf657cdac91e98579caf09005d3422065` (PR #478 exact head `4c748ce5f7988da9f61dd1e4650351b5d6c8bf72`; merge `36d7b33a5483cff63715b7981794aff1de614ae2`; exact-head `PASS`; canonical workflow `31886172712`).
...
7. **Ordered implementation slices.** docs/ARCHITECTURE_BOOK.md, docs/CURRENT_STATUS.md, docs/FUTURE_ROUTE.md, docs/MODULE_MAP.md, docs/NEXT_DECISION.md: Promote the accepted AC3 contract and bind its file-level ownership split.; engine/src/product_golden_path.rs, engine/src/storage/local_product_store/managed_acceptance.rs, engine/src/storage/local_product_store/product_tasks.rs: Freeze pure orchestration, LocalProductStore mutation, and external-effect boundaries without semantic change.; engine/tests/test_product_golden_path_g3.rs, engine/tests/test_product_golden_path_recovery.rs: Bind existing Golden Path and recovery tests as equivalence anchors before implementation packets.
...
9. **Verification.** python scripts/check_agent_handoff.py; git diff --check
