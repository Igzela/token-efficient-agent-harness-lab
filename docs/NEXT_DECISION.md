...
```text
[window: PE7-HE-EC2-CONTRACT-1 — READY_FOR_EXECUTION, provider-free]
...
**Historical evidence:** PR #527 exact head `98dc94342c86c2cd065f4a7b983a4ac0bd049042`; merge `da7f2eeeb84bccaf45ef6835169f66e3d65ba2c4`; exact-head `PASS`; canonical workflow `31944903259`.
## Packet PE7-HE-EC2-CONTRACT-1

**State:** `READY_FOR_EXECUTION`

**Prerequisite:** PE7-HE-EC1-MUTATION-REGISTRY-1 — COMPLETE on accepted main `da7f2eeeb84bccaf45ef6835169f66e3d65ba2c4` (PR #527 exact head `98dc94342c86c2cd065f4a7b983a4ac0bd049042`; merge `da7f2eeeb84bccaf45ef6835169f66e3d65ba2c4`; exact-head `PASS`; canonical workflow `31944903259`).
...
1. **Outcome and non-goals.** Freeze evaluator constellation, sealed holdout, reviewer policy, immutable labels, access classes, contamination/gaming/safety sentinels, invalidation, and evaluator-owned `PredictionOutcomeV1` derivation rules.
2. **Prerequisites and evidence.** Accepted main `da7f2eeeb84bccaf45ef6835169f66e3d65ba2c4`; checked route manifest SHA `1947e0fc60f0c8f6e3dbb8752479f05e7dd4b09412daa8617212403c548c8896`; predecessor receipt PR #527 exact head `98dc94342c86c2cd065f4a7b983a4ac0bd049042`; merge `da7f2eeeb84bccaf45ef6835169f66e3d65ba2c4`; exact-head `PASS`; canonical workflow `31944903259`; current-main evidence SHA `349b08562119f4c58e390a69562904909435596a1361854bd90ceadf08a22693`.
...
4. **Frozen invariants.** Packet identity, route manifest SHA `1947e0fc60f0c8f6e3dbb8752479f05e7dd4b09412daa8617212403c548c8896`, accepted-main SHA, predecessor receipt, and current-main evidence digest are immutable for this candidate.
...
7. **Ordered implementation slices.** docs/ARCHITECTURE_BOOK.md, docs/CURRENT_STATUS.md, docs/FUTURE_ROUTE.md, docs/MODULE_MAP.md, docs/NEXT_DECISION.md: Bind the accepted Harness Evolution EC2 contract execution window.; scripts/agent-control/local_verification.py, scripts/agent-control/route_driver.py, scripts/check_agent_handoff.py, scripts/session_context.py, tests/test_agent_route_driver.py, tests/test_session_context.py: Enforce bounded route-control edit/read/verification scope and prove EC2 contract tests.
8. **Failure, recovery, and stop taxonomy.** Cleanup: No runtime mutation or cleanup required for EC2 contract. (proved by docs/ARCHITECTURE_BOOK.md:recovery); retention: Retain the accepted EC1 mutation registry receipt. (proved by docs/CURRENT_STATUS.md:receipt); decisions: authority unchanged (docs/MODULE_MAP.md:authority); evaluator unchanged (docs/CURRENT_STATUS.md:evaluator); recovery unchanged (docs/ARCHITECTURE_BOOK.md:recovery); schema unchanged (docs/CURRENT_STATUS.md:schema).
