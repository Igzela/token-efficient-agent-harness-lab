...
**Historical evidence:** PR #507 exact head `8b47cc6f84a195ce883476f1b28ed5427b67f2a9`; merge `c3aa5f7c6b03944ca0b652af40402631877eacbb`; exact-head `PASS`; canonical workflow `31933628519`.
## Packet PE7-RWE-CR-RECONSTRUCTION-1

**State:** `READY_FOR_EXECUTION`

**Prerequisite:** PE7-AC7-CLOSEOUT-1 — COMPLETE on accepted main `c3aa5f7c6b03944ca0b652af40402631877eacbb` (PR #507 exact head `8b47cc6f84a195ce883476f1b28ed5427b67f2a9`; merge `c3aa5f7c6b03944ca0b652af40402631877eacbb`; exact-head `PASS`; canonical workflow `31933628519`).
...
2. **Prerequisites and evidence.** Accepted main `c3aa5f7c6b03944ca0b652af40402631877eacbb`; checked route manifest SHA `8569f8aad2dd6672e75a44ed6f61c72f852c0a3290744d957e0bc762d9acde7f`; predecessor receipt PR #507 exact head `8b47cc6f84a195ce883476f1b28ed5427b67f2a9`; merge `c3aa5f7c6b03944ca0b652af40402631877eacbb`; exact-head `PASS`; canonical workflow `31933628519`; current-main evidence SHA `8df04c5eedab98ae6482087e048404ab0c20dd36415fc59369c0366c8dfec1e2`.
...
7. **Ordered implementation slices.** docs/ARCHITECTURE_BOOK.md, docs/CURRENT_STATUS.md, docs/FUTURE_ROUTE.md, docs/MODULE_MAP.md, docs/NEXT_DECISION.md: Bind the accepted RWE contemporary reconstruction execution window.; engine/src/rwe/corpus.rs, engine/src/rwe/operator_corpus.rs, engine/src/rwe/runner.rs, engine/src/storage/local_product_store/rwe_authority.rs, engine/tests/test_pg_integration.rs, scripts/check_wire_codegen_drift.sh: Rebuild and provider-free validate the frozen pre-AC Harness beside the accepted post-AC Harness.
8. **Failure, recovery, and stop taxonomy.** Cleanup: No runtime mutation or cleanup required for RWE reconstruction. (proved by docs/ARCHITECTURE_BOOK.md:recovery); retention: Retain the accepted AC closeout receipt. (proved by docs/CURRENT_STATUS.md:receipt); decisions: authority unchanged (docs/MODULE_MAP.md:authority); evaluator unchanged (docs/CURRENT_STATUS.md:evaluator); recovery unchanged (docs/ARCHITECTURE_BOOK.md:recovery); schema unchanged (docs/CURRENT_STATUS.md:schema).
...
10. **Compatibility, rollback, and retention.** Revert reconstruction adapters and restore the prior AC closeout window. (proved by docs/ARCHITECTURE_BOOK.md:recovery)
...
{"allowed_outputs": ["A provider-free change limited to the independently proved current-main allowed paths.", "Exact-head verification and review evidence through the existing lifecycle owners."], "allowed_paths": ["docs/ARCHITECTURE_BOOK.md", "docs/CURRENT_STATUS.md", "docs/FUTURE_ROUTE.md", "docs/MODULE_MAP.md", "docs/NEXT_DECISION.md", "engine/src/rwe/corpus.rs", "engine/src/rwe/operator_corpus.rs", "engine/src/rwe/runner.rs", "engine/src/storage/local_product_store/rwe_authority.rs", "engine/tests/test_pg_integration.rs", "scripts/check_wire_codegen_drift.sh"], "authority_consumption_allowed": false, "dispatch_lane": "provider_free_repository_maintenance", "expected_artifacts": ["Canonical route evidence. (docs/NEXT_DECISION.md:canonical)"], "external_effect_limit": 0, "forbidden_changes": ["Do not use FUTURE_ROUTE static paths as current-main authority.", "Do not create a second controller, ledger, queue, lease, store, or workflow owner.", "Do not mint T3 authority, execute an EFFECT, auto-merge, call a Provider, or write a target."], "forbidden_next_actions": ["Do not skip an EFFECT node or execute an EFFECT or T3 path without its exact valid finite receipt.", "Do not treat missing, conflicting, stale, or outcome-unknown routing or receipts as success.", "Do not start a successor whose promotion candidate has not been independently accepted.", "Do not use FUTURE_ROUTE static paths as current-main authority.", "Do not create a second controller, ledger, queue, lease, store, or workflow owner.", "Do not mint T3 authority, execute an EFFECT, auto-merge, call a Provider, or write a target."], "goal": "Rebuild and provider-free validate the frozen pre-AC Harness beside the accepted post-AC Harness under isolated identities.", "ordered_steps": ["docs/ARCHITECTURE_BOOK.md, docs/CURRENT_STATUS.md, docs/FUTURE_ROUTE.md, docs/MODULE_MAP.md, docs/NEXT_DECISION.md: Bind the accepted RWE contemporary reconstruction execution window.", "engine/src/rwe/corpus.rs, engine/src/rwe/operator_corpus.rs, engine/src/rwe/runner.rs, engine/src/storage/local_product_store/rwe_authority.rs, engine/tests/test_pg_integration.rs, scripts/check_wire_codegen_drift.sh: Rebuild and provider-free validate the frozen pre-AC Harness beside the accepted post-AC Harness."], "packet_id": "PE7-RWE-CR-RECONSTRUCTION-1", "packet_state": "READY_FOR_EXECUTION", "pause_gates": ["Stop when an owner, caller, test, path, operation, destination, or decision cannot be re-proved from accepted main.", "Stop when exact-head review or canonical CI is missing, stale, failed, or conflicting.", "Recover ordinary worker, CI, review, checkpoint, duplicate, restart, and main-drift failures through existing owners; stop if recovery evidence is unproved.", "Stop before a Provider, target, automatic merge, authority consumption, or external effect.", "Do not retry a possibly executed external effect whose outcome is unknown."], "plan_lane_state": "plan_lane_active", "prerequisite_receipts": ["PR #507 exact head `8b47cc6f84a195ce883476f1b28ed5427b67f2a9`; merge `c3aa5f7c6b03944ca0b652af40402631877eacbb`; exact-head `PASS`; canonical workflow `31933628519`"], "prerequisites": ["PE7-AC7-CLOSEOUT-1"], "private_paths_allowed": false, "promotion_evidence_sha256": "8df04c5eedab98ae6482087e048404ab0c20dd36415fc59369c0366c8dfec1e2", "read_paths": ["docs/ARCHITECTURE_BOOK.md", "docs/CURRENT_STATUS.md", "docs/FUTURE_ROUTE.md", "docs/MODULE_MAP.md", "docs/NEXT_DECISION.md", "engine/src/rwe/corpus.rs", "engine/src/rwe/operator_corpus.rs", "engine/src/rwe/runner.rs", "engine/src/storage/local_product_store/rwe_authority.rs", "engine/tests/test_pg_integration.rs", "scripts/check_wire_codegen_drift.sh"], "risk_class": "none", "rollback": "Revert reconstruction adapters and restore the prior AC closeout window. (proved by docs/ARCHITECTURE_BOOK.md:recovery)", "route_manifest_sha256": "8569f8aad2dd6672e75a44ed6f61c72f852c0a3290744d957e0bc762d9acde7f", "schema_version": "weak_agent_dispatch.v1", "secret_values_allowed": false, "verification": ["bash scripts/check_wire_codegen_drift.sh", "uv run --no-project python scripts/check_agent_handoff.py", "git diff --check"], "verification_family": "source_focused_full", "worker_tier": "T1"}
-->
