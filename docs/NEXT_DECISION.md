...
**Historical evidence:** PR #500 exact head `9e4e2a1cc81b5f8ffa434d734e57dc083d8b395f`; merge `516418883104db21449d0d4fdba63e5b837a463d`; exact-head `PASS`; canonical workflow `31932059394`.
## Packet PE7-AC6-SDK-MIGRATION-1

**State:** `READY_FOR_EXECUTION`

**Prerequisite:** PE7-AC6-RUST-CODEGEN-1 — COMPLETE on accepted main `516418883104db21449d0d4fdba63e5b837a463d` (PR #500 exact head `9e4e2a1cc81b5f8ffa434d734e57dc083d8b395f`; merge `516418883104db21449d0d4fdba63e5b837a463d`; exact-head `PASS`; canonical workflow `31932059394`).
...
2. **Prerequisites and evidence.** Accepted main `516418883104db21449d0d4fdba63e5b837a463d`; checked route manifest SHA `1aaee4cf680245845c3dfe69aeac2b91162da921a1d91300db87b5111cb4a1c3`; predecessor receipt PR #500 exact head `9e4e2a1cc81b5f8ffa434d734e57dc083d8b395f`; merge `516418883104db21449d0d4fdba63e5b837a463d`; exact-head `PASS`; canonical workflow `31932059394`; current-main evidence SHA `c08df242be88087be10023a34d9da01098c909980e576c16bd1886befd7778ac`.
...
7. **Ordered implementation slices.** docs/ARCHITECTURE_BOOK.md, docs/CURRENT_STATUS.md, docs/FUTURE_ROUTE.md, docs/MODULE_MAP.md, docs/NEXT_DECISION.md: Bind the accepted AC6 SDK migration execution window.; codegen/generate_wire_types.py, engine/src/storage/local_product_store/product_tasks.rs, engine/src/wire_types.rs, engine/tests/test_product_golden_path_g3.rs, scripts/check_wire_codegen_drift.sh, sdk/python/src/agent_control_plane_sdk/wire_types.py, sdk/typescript/src/generated-wire-types.ts: Migrate Python and TypeScript SDK packages to generated wire types.
8. **Failure, recovery, and stop taxonomy.** Cleanup: No runtime mutation or cleanup required for SDK migration. (proved by docs/ARCHITECTURE_BOOK.md:recovery); retention: Retain the accepted AC6 codegen receipt. (proved by docs/CURRENT_STATUS.md:receipt); decisions: authority unchanged (docs/MODULE_MAP.md:authority); evaluator unchanged (docs/CURRENT_STATUS.md:evaluator); recovery unchanged (docs/ARCHITECTURE_BOOK.md:recovery); schema unchanged (docs/CURRENT_STATUS.md:schema).
...
10. **Compatibility, rollback, and retention.** Revert SDK migration changes if client wire bindings diverge. (proved by docs/ARCHITECTURE_BOOK.md:recovery)
