...
```text
[window: PE7-CWS-BENCHMARK-PROTOCOL-1 — READY_FOR_EXECUTION, provider-free]
...
**Historical evidence:** PR #519 exact head `99eadbfcb2e6416f6864c8a2edc2fbead3cc4801`; merge `8ff33f7c9ebce55b94bb9c0e813c12c7a8d40c26`; exact-head `PASS`; canonical workflow `31936724895`.
## Packet PE7-CWS-BENCHMARK-PROTOCOL-1

**State:** `READY_FOR_EXECUTION`

**Prerequisite:** PE7-CWS-CACHE-PARTITION-1 — COMPLETE on accepted main `8ff33f7c9ebce55b94bb9c0e813c12c7a8d40c26` (PR #519 exact head `99eadbfcb2e6416f6864c8a2edc2fbead3cc4801`; merge `8ff33f7c9ebce55b94bb9c0e813c12c7a8d40c26`; exact-head `PASS`; canonical workflow `31936724895`).
...
1. **Outcome and non-goals.** Pre-register a hard-gate-first comparison of the exact post-AC baseline with the CWS treatment using existing token-efficiency, scorecard, artifact, review, and lifecycle-cost owners, plus post-gate implementation-maintenance-burden evidence.
2. **Prerequisites and evidence.** Accepted main `8ff33f7c9ebce55b94bb9c0e813c12c7a8d40c26`; checked route manifest SHA `5c0acb88ec811ae56f888b65cc718b65fbe092e061478a5d28bac450b064d5c1`; predecessor receipt PR #519 exact head `99eadbfcb2e6416f6864c8a2edc2fbead3cc4801`; merge `8ff33f7c9ebce55b94bb9c0e813c12c7a8d40c26`; exact-head `PASS`; canonical workflow `31936724895`; current-main evidence SHA `70c071f3d29ebe3981c3e6995248a6559c17bae1892582fd028bf93e4e4d963c`.
...
4. **Frozen invariants.** Packet identity, route manifest SHA `5c0acb88ec811ae56f888b65cc718b65fbe092e061478a5d28bac450b064d5c1`, accepted-main SHA, predecessor receipt, and current-main evidence digest are immutable for this candidate.
...
7. **Ordered implementation slices.** docs/ARCHITECTURE_BOOK.md, docs/CURRENT_STATUS.md, docs/FUTURE_ROUTE.md, docs/MODULE_MAP.md, docs/NEXT_DECISION.md: Bind the accepted context working-set benchmark protocol execution window.; scripts/agent-control/local_verification.py, scripts/agent-control/route_driver.py, scripts/check_agent_handoff.py, scripts/project_context.py, scripts/session_context.py, tests/test_agent_route_driver.py, tests/test_session_context.py: Enforce bounded route-control edit/read/verification scope and prove benchmark protocol tests.
8. **Failure, recovery, and stop taxonomy.** Cleanup: No runtime mutation or cleanup required for benchmark protocol. (proved by docs/ARCHITECTURE_BOOK.md:recovery); retention: Retain the accepted CWS cache partition receipt. (proved by docs/CURRENT_STATUS.md:receipt); decisions: authority unchanged (docs/MODULE_MAP.md:authority); evaluator unchanged (docs/CURRENT_STATUS.md:evaluator); recovery unchanged (docs/ARCHITECTURE_BOOK.md:recovery); schema unchanged (docs/CURRENT_STATUS.md:schema).
