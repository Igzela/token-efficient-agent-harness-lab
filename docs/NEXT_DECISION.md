...
10. **Compatibility, rollback, and retention.** Revert this AC2 contract-freeze head and its three-document delta while retaining the accepted AC0 trace/order evidence and prior failure evidence.
