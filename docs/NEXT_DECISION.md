...
| Architecture refactor (R-series) | R1 complete: http_server split into module directory. Next candidate: R2 LocalProductStore split (storage/local_product_store.rs is 1600+ lines). Each refactor preserves all public behavior and tests. |
