...
pub const PROVIDER_AUDIT_EVENT_TYPES: &[&str] = &[
    ...
    "adaptive_single_request",
    "adaptive_single_response",
    "adaptive_single_error",
    "adaptive_single_timeout",
    "adaptive_fallback_request",
    "adaptive_fallback_response",
    "adaptive_fallback_error",
    "adaptive_fallback_timeout",
    "adaptive_panel_request",
    "adaptive_panel_response",
    "adaptive_panel_error",
    "adaptive_panel_timeout",
    "adaptive_judge_request",
    "adaptive_judge_response",
    "adaptive_judge_error",
    "adaptive_judge_timeout",
    "adaptive_synthesizer_request",
    "adaptive_synthesizer_response",
    "adaptive_synthesizer_error",
    "adaptive_synthesizer_timeout",
];
