...
fn axum_routes() -> Router<AxumApiState> {
    Router::new()
        ...
        .route(
            ...
            post(product_tasks::api_create_product_task).options(cors_preflight),
        )
        .route(
            "/api/v1/product/tasks/:task_id",
            get(product_tasks::api_product_task_detail).options(cors_preflight),
        )
        .route(
            "/api/v1/product/tasks/:task_id/recover-workspace",
        ...
        .route(
            "/api/v1/product/tasks/:task_id/finalize",
            post(product_tasks::api_finalize_product_task).options(cors_preflight),
        )
        .route(
            "/api/v1/product/tasks/:task_id/delegated/prepare",
            post(product_tasks::api_prepare_delegated_product_task).options(cors_preflight),
        )
        .route(
            "/api/v1/product/tasks/:task_id/delegated/activate",
            post(product_tasks::api_activate_delegated_product_task).options(cors_preflight),
        )
        .route(
            "/api/v1/product/tasks/:task_id/delegated/approve",
            post(product_tasks::api_approve_delegated_product_task).options(cors_preflight),
        )
        .route(
        ...
        .route(
            "/api/v1/regressions",
            get(scorecards::api_regression_artifacts).options(cors_preflight),
        )
        .route(
            "/api/v1/regressions/trends/:scenario_id",
            get(scorecards::api_regression_trend).options(cors_preflight),
        )
        .route(
        ...
        .route(
            ...
            post(scheduler::api_scheduler_control).options(cors_preflight),
        )
        .route(
