...
pub use managed_acceptance::{
    ...
    DelegationContract, EffectChildAuthorizationRequest, EffectEnvelopeContract,
    ...
    EFFECT_CHILD_AUTHORIZATION_SCHEMA_VERSION, EFFECT_ENVELOPE_APPROVAL_PHRASE,
    EFFECT_ENVELOPE_SCHEMA_VERSION, EFFECT_OUTCOME_UNKNOWN, MANAGED_OUTPUT_OPERATOR_KEY_SCOPES,
