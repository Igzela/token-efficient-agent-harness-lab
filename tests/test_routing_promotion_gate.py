...
class PromotionGateTests(unittest.TestCase):
    def test_insufficient_data(self):
        ...
        verdict = gate.evaluate("code/review", "cheap_executor")
    ...
    def test_promotes_when_all_conditions_met(self):
        ...
        verdict = gate.evaluate("code/review", "cheap_executor", "balanced_worker")
    ...
    def test_insufficient_baseline_samples(self):
        ...
        verdict = gate.evaluate("code/review", "cheap_executor", "balanced_worker")
        self.assertEqual(verdict.verdict, "insufficient_data")
        self.assertIn("insufficient_baseline_samples", verdict.reasons[0])
    ...
    def test_promotion_verdict_to_dict(self):
        ...
        self.assertEqual(d["task_group"], "code/review")
    ...
    def test_check_sample_count(self):
        ...
        for i in range(10):
            store.add_observation(_make_obs("cheap_executor", "code", "review", 0.9, 0.005, True))
        gate = PromotionGate(store, min_sample_count=30)
        sufficient, count = gate.check_sample_count("code/review", "cheap_executor")
