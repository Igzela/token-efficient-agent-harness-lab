...
grep -Fq 'safe signed tag' "${INSTALLER}"
grep -Fq 'unsafe release archive member' "${INSTALLER}"
grep -Fq 'Archive member contract passed.' "${INSTALLER}"
grep -Fq 'sourceRepositoryRef' "${ROOT}/scripts/release_provenance.py"
grep -Fq 'verifiedTimestamps' "${ROOT}/scripts/release_provenance.py"
