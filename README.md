...
Current result: 1200 Rust tests pass. Python SDK tests run separately under `sdk/python/`.
...
- Batch 6 sandbox/workspace/approval/rollback/artifact-capture contracts and Batch 7 Slice A storage metadata are not runtime execution capability.
