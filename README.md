...
[![Tests](https://img.shields.io/badge/tests-1587%20passing-brightgreen.svg)](#running-tests)
...
Current result: 1587 Rust tests pass. Python SDK tests run separately under `sdk/python/`.
