...
[![Tests](https://img.shields.io/badge/tests-1653%20passing-brightgreen.svg)](#running-tests)
...
Current result: 1653 Rust tests pass. Python SDK tests run separately under `sdk/python/`.
