...
[![Tests](https://img.shields.io/badge/tests-1597%20passing-brightgreen.svg)](#running-tests)
...
Current result: 1597 Rust tests pass. Python SDK tests run separately under `sdk/python/`.
